declare module ZoomCharts.Configuration {
    ...
    export interface BaseApi {
        ...
        /** Removes data and updates the chart. */
        replaceData(data: any, sourceId?: string): void;
    ...
    export interface BaseProfiler {
        ...
        measureFps(measureFpsIters: any, measureFpsCallback: (fps: number, iterations: number, time: number) => void): boolean;
    }
    ...
    export interface BaseTimeStep {
        add(time: number, times?: number): number;
        approxTime(): number;
        clone(): BaseTimeStep;
        count: number;
        getBigger(): BaseTimeStep;
        isBigger(smaller: BaseTimeStep): boolean;
        isEqual(step: BaseTimeStep): boolean;
        isSmaller(bigger: BaseTimeStep): boolean;
        isSmallerOrEqual(bigger: BaseTimeStep): boolean;
        name: string;
        numberOfUnits(from: number, to: number): number;
        roundTimeDown(time: number): number;
        roundTimeRound(time: number): number;
        roundTimeUp(time: number): number;
        sub(time: number, times?: number): number;
        toString(): string;
        unit: string;
    }
    ...
    export interface FacetChartSettings {
        ...
        /** The events used to handle user interaction with UI elements. See see::interactivity/::events:: for more info. */
        events?: LinearChartSettingsEvents;
    ...
    export interface FacetChartSettingsSeries {
    ...
    export interface FacetChartSettingsSeriesColumns {
        /** Cluster identifier. Columns with the same cluster id will be placed in same cluster. */
        cluster?: string;
        /** Data manipulation settings used for default series. */
        data?: FacetChartSettingsSeriesData;
    ...
    export interface FacetChartSettingsSeriesColumnsStyle {
        ...
        For example: [[-16, 'rgba(0,0,255,0.4)'],[30,'rgba(255,0,0,0.7)']]. */
    ...
    export interface FacetChartSettingsSeriesData {
    ...
    export interface FacetChartSettingsSeriesLines {
        /** Cluster identifier. Columns with the same cluster id will be placed in same cluster. */
        cluster?: string;
        /** Data manipulation settings used for default series. */
        data?: FacetChartSettingsSeriesData;
    ...
    export interface GeoChartSettingsArea {
        /** Height of the chart. If undefined the chart height will adapt to container element. */
        height?: number;
        /** The horizontal position of the chart. This setting only applies when this chart is nested within another by using `parentChart` setting. */
        left?: number;
    ...
    export interface GeoChartSettingsAreaStyle {
        /** Background fill color of chart area */
        fillColor?: string;
        /** The foreground fill color of the chart area. `rgba()` with alpha transparency should be used */
        overlayColor?: string;
    ...
    export interface GeoChartSettingsLayerCharts {
        ...
        settingsFunction?: (node: ItemsChartNode, data: GeoChartDataObjectNode) => (TimeChartSettings|PieChartSettings|FacetChartSettings);
    ...
    export interface GeoChartSettingsNodesLayerStyle {
        ...
        /** Default link style.
        Note see::chart-basics/style/#style-ordering::style setting precedence:: */
    ...
    export interface ItemsChartDataObjectLink {
        className?: string;
        /** The ID of the node where the link originates. */
        from: string;
        /** The unique identifier of the link. */
    ...
    export interface ItemsChartDataObjectNode {
        className?: string;
        /** The unique identifier of the node. */
        id: string;
        loaded: boolean;
    ...
    export interface ItemsChartLink {
        ...
        hovered: boolean;
        id: string;
        /** Specifies if the link is invisible - thus completely skipping the drawing and hit testing. This can be used, for example, to hide
        links that do not meet certain criteria using `linkStyleFunction`. */
        invisible: boolean;
    ...
    export interface ItemsChartNode {
        ...
        * anchorMode = "Fixed" - the value is in pixels from top-left corner of the chart area. */
        ...
        dataLinksFiltered: Array<ItemsChartDataObjectLink>;
        /** Valid values: image, text, roundtext, customShape, line, polygon, circle, droplet */
        display?: string;
        expanded: boolean;
        fillColor?: string;
        ...
        /** Specifies the image cropping method. Valid values are `false` (disable cropping), `true` (default cropping mode), `"crop"`, `"letterbox"` and `"fit"`. */
        imageCropping?: (string|boolean);
        /** Specifies if the node is invisible - thus completely skipping the drawing and hit testing. */
        invisible: boolean;
        /** Gets a list of additional items for the particular node. To add additional items, add a new object to this array. */
        items: Array<ItemsChartSettingsNodeItem>;
        /** The label text that is displayed below the node. Set to an empty string "" to remove the label if it has been added before. */
        label?: string;
        labelStyle?: ItemsChartSettingsItemsLayerLabelStyle;
    ...
    export interface ItemsChartSettingsCustomShape {
        ...
        paintSelection?: (node: ItemsChartNode, 
            /** The canvas 2d rendering context for rendering */
            context: CanvasRenderingContext2D, 
            /** The X value of the center coordinate, where node needs to be rendered */
            x: number, 
    ...
    export interface ItemsChartSettingsItemsLayerLinkLabelStyle {
        /** Text alignment. */
        align?: string;
        /** The angle at which the label are rotated */
        angle?: number;
    ...
    /** Node item. */
    export interface ItemsChartSettingsNodeItem {
        /** Text alignment. */
        align?: string;
        /** The angle at which the label are rotated */
        angle?: number;
    ...
    export interface LinearChartSettingsEvents {
        /** Time to wait after last action before firing onChartUpdate event. */
        chartUpdateDelay?: number;
    ...
    export interface LinearChartSettingsLegendAdvanced {
    ...
    export interface LinearChartSettingsSeriesColumnsStyle {
        /** Depth for column. Use it to achieve 3D effect. */
        depth?: number;
        /** Brightness applied to depth components. */
        depthBrightness?: number;
    ...
    export interface NetChartSettings {
        ...
        See see::chart-basics/style/::style documentation:: for more details. */
    ...
    export interface TimeChartDisplayPeriod {
        displayAnchor: string;
        displayPeriod: BaseTimeStep;
        /** The original period string from which `displayPeriod` was parsed. */
        displayPeriodStr: string;
        displayUnit: BaseTimeStep;
        name: string;
        selected: boolean;
    }
    ...
    export interface TimeChartSettingsCurrentTime {
        /** Show/hide the marker that shows the current time. */
        enabled?: boolean;
        /** Adds an additional label in front of the current date/time */
        label?: string;
        /** Allows overriding the position of the current time marker. Timestamp should be UTC in milliseconds. */
        overrideCurTime?: number;
        /** Specifies if the current time is always included when limiting scrolling. If this is `true`, then the user will always
        be able to scroll to the current time even if the data is not available. */
        overridesLimits?: boolean;
        /** The style for the vertical marker line. */
        style?: BaseSettingsBackgroundStyle;
        /** The style for the label and current time string. If this is `null`, then `style.fillColor` will be used. */
        textStyle?: BaseSettingsTextStyle;
    }
    ...
    export interface TimeChartSettingsSeries {
        /** Cluster identifier. Columns with the same cluster id will be placed in same cluster. */
        cluster?: string;
        /** Data manipulation settings used for default series. */
    ...
    export interface TimeChartSettingsSeriesCandleStick {
        /** Cluster identifier. Columns with the same cluster id will be placed in same cluster. */
        cluster?: string;
        /** Data manipulation settings used for default series. */
    ...
    export interface TimeChartSettingsSeriesCandleStickData {
        /** Prepare displaying value after data aggregation. */
        aggregatedValueFunction?: (
            /** aggregated value that is about to be displayed */
            value: any, 
    ...
    export interface TimeChartSettingsSeriesColumns {
        /** Cluster identifier. Columns with the same cluster id will be placed in same cluster. */
        cluster?: string;
        /** Data manipulation settings used for default series. */
        data?: TimeChartSettingsSeriesData;
    ...
    export interface TimeChartSettingsSeriesData {
        /** Prepare displaying value after data aggregation. */
        aggregatedValueFunction?: (
            /** aggregated value that is about to be displayed */
            value: any, 
    ...
    export interface TimeChartSettingsSeriesLines {
        /** Cluster identifier. Columns with the same cluster id will be placed in same cluster. */
        cluster?: string;
        /** Data manipulation settings used for default series. */
        data?: TimeChartSettingsSeriesData;
...
declare module ZoomCharts {
    ...
    export class FacetChart {
        ...
        /** Adds specific data and updates the chart. */
        public addData(data: any, sourceId?: string): void;
        /** 
        @deprecated use settings.parentChart instead. */
        ...
        public customize(name: string): Configuration.BaseApi;
        ...
        public home(): boolean;
        public off(name: string, listener: any): boolean;
        /** Adds event listener.
        Supported event types: "timeChange", "selectionChange, "click", "doubleClick".
        Consult doc for event types in specific SDK */
        public on(name: string, listener: any): number;
        /** Does immediate repaint. Use to sync updates between multiple charts. */
        ...
        /** Removes data and updates the chart. */
        public replaceData(data: any, sourceId?: string): void;
        public replaceSeries(series: any): void;
    ...
    export class NetChart {
        ...
        /** Adds specific data and updates the chart. */
        public addData(data: any, sourceId?: string): void;
        public addFocusNode(id: (string|Configuration.ItemsChartNode), range?: number): Configuration.FocusNode;
        /** 
        @deprecated use settings.parentChart instead. */
        public addSubchartContainer(container: HTMLElement): void;
        public back(): Configuration.BaseApi;
        ...
        public clearHistory(): Configuration.BaseApi;
        public collapseNode(id: (string|Configuration.ItemsChartNode)): Configuration.FocusNode;
        public customize(name: string): Configuration.BaseApi;
        public expandNode(id: (string|Configuration.ItemsChartNode)): Configuration.FocusNode;
        public export(type: any, dimensions: any, transparent: any): void;
        ...
        public hideMenu(): Configuration.BaseApi;
        public hideNode(id: (string|Configuration.ItemsChartNode)): Configuration.FocusNode;
        public home(): boolean;
        public links(): Array<Configuration.ItemsChartLink>;
        public lockNode(id: (string|Configuration.ItemsChartNode), x: any, y: any): void;
        ...
        /** Removes data and updates the chart. */
        public removeData(data: any, sourceId?: string): void;
        public removeFocusNode(id: (string|Configuration.ItemsChartNode)): Configuration.FocusNode;
        /** Removes data and updates the chart. */
        public replaceData(data: any, sourceId?: string): void;
        ...
        public showNode(id: (string|Configuration.ItemsChartNode)): Configuration.FocusNode;
        /** Gets the name of the chart the JavaScript object references. For example 'PieChart' or 'TimeChart'. This field is read-only. */
        public typeName: string;
        public unlockNode(id: (string|Configuration.ItemsChartNode)): void;
        /** Re-evaluate data filters on next paint. */
        public updateFilters(): void;
        /** Updates the chart settings. Only the settings that have to be changed should be passed. */
    ...
    export class TimeChart {
        ...
        public clearHistory(): Configuration.BaseApi;
        public customize(name: string): Configuration.BaseApi;
        public displayUnit(unit: any, animate?: boolean, rescale?: boolean, rescaleCenter?: any): string;
        public export(type: any, dimensions: any, transparent: any): void;
        /** returns data uri string */
        public exportGetDimensions(dimensions: any): {
                width: number;
        ...
        public setDisplayPeriod(period: any, anchor: any, animate: any): void;
        ...
        /** Re-evaluate style for all objects on next paint. */
        public updateStyle(): void;
        public zoomIn(unit?: any, center?: any, animate?: boolean): void;
        public zoomOut(unit?: any, animate?: boolean): void;
    }
    /* tslint:enable */
}

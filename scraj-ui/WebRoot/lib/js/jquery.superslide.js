...
(function($){
	$.fn.slide=function(options){
		...
		interTime : 2500,//鑷姩杩愯闂撮殧銆傚綋effect涓烘棤缂濇粴鍔ㄧ殑鏃跺�锛岀浉褰撲簬杩愯閫熷害銆�
		defaultIndex : 0,//榛樿鐨勫綋鍓嶄綅缃储寮曘�0鏄涓�釜
		titCell:".hd li",//瀵艰埅鍏冪礌
		mainCell:".bd",//鍐呭鍏冪礌鐨勭埗灞傚璞�
		trigger: "click",//瑙﹀彂鏂瑰紡 || mouseover锛氶紶鏍囩Щ杩囪Е鍙戯紱|| click锛氶紶鏍囩偣鍑昏Е鍙戯紱
		scroll:1,//姣忔婊氬姩涓暟銆�
		vis:1,//visible锛屽彲瑙嗚寖鍥翠釜鏁帮紝褰撳唴瀹逛釜鏁板皯浜庡彲瑙嗕釜鏁扮殑鏃跺�锛屼笉鎵ц鏁堟灉銆�
		...
		prevCell:".aaaa",//鍓嶄竴涓寜閽厓绱犮�
		nextCell:".bbb"//鍚庝竴涓寜閽厓绱犮�zz
		};
